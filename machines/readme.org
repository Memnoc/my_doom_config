...
** System Differences
| Feature        | Arch + Niri           | Pop!_OS                |
|----------------+-----------------------+------------------------|
| Emacs install  | =yay -S emacs-wayland=  | Build from source      |
| fd package     | =fd=                    | =fd-find=                |
| vterm deps     | =libvterm=              | =libvterm-dev=           |
| Desktop entry  | Automatic             | Automatic (from build) |
